...
--     Fixed & Enhanced with Anti-Lag + WA Channel
-- ==============================================
...
for _, obj in ipairs(workspace:GetDescendants()) do
    ...
    if obj.Name == "Generator" then 
        ESPCache.Generators[obj] = true  -- FIXED: was "tru"
...
local function createESP(obj, color)
    ...
    -- Skip ESP highlight if anti-lag is enabled
...
local function applyAntiLag()
    ...
    -- Disable Animations (skip if possible)
...
-- ... (ESP UI elements - same as before, keeping all features)
...
-- ==============================================
-- 46. PLAYER TAB (Survivor & Killer - same as before)
-- ==============================================
...
-- ==============================================
-- 50. CROSSHAIR BOX (same as before)
-- ==============================================
...
-- ==============================================
-- 51. MISC TAB (Movement, Emote, Fun)
-- ==============================================
...
-- ==============================================
-- 54. STARTUP NOTIFICATION
-- ==============================================

Library:Notify({ 
    Title = "GanKunZ Hub", 
    Description = "Loaded! Anti-Lag + WA Channel Ready!",
    Time = 3 
})
