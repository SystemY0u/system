...
-- ==============================================
-- 3.5 VARIABLES TAMBAHAN (WhatsApp, Server Hop)
-- ==============================================
...
-- Fungsi untuk join server berdasarkan serverId
...
-- Fungsi untuk mencari server terbaik
local function FindBestServer(region)
    ...
    -- Filter berdasarkan region jika diperlukan
...
local function RejoinServer()
    ...
    if not success then
        Library:Notify({
            Title = "Rejoin",
            Description = "Gagal rejoin: " .. tostring(err),
            Time = 3
        })
        return false
    end
...
-- Fungsi untuk membuka WhatsApp Channel
...
-- Fungsi untuk membuat tombol WhatsApp di UI
...
-- Fungsi untuk auto rejoin ketika keluar
local function SetupAutoRejoin()
    if ServerHop.Enabled then
        ...
        conn = LocalPlayer.OnTeleport:Connect(function(state)
            ...
            -- Cleanup connection setelah teleport
            if conn then
                conn:Disconnect()
                conn = nil
            end
...
-- ==============================================
-- 39.5 INIT TAMBAHAN (WhatsApp, Server Hop)
-- ==============================================
